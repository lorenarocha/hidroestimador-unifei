...
'set shpopts -1'
'set line 1 1 12'
'draw shp ../src/shapefile/nordeste/nordeste.shp'

'set font 4'
'draw title PRECIPITACAO INSTANTANEA (mm/h) \ NORDESTE - 'data''
'set xlab LONGITUDE'
'set ylab LATITUDE'

'printim ../output/ultima_img_NE.png x1400 y1000'

'quit'
EOF

grads -lbc "${file}_NE.gs"
rm ${file}_NE.gs
