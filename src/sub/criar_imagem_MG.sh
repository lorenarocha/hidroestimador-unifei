...
'set shpopts -1'
'set line 1 1 12'
'draw shp ../src/shapefile/mg_municipios_2018/MG_Municipio_2018shp.shp'

'set font 4'
'draw title PRECIPITACAO INSTANTANEA (mm/h) \ MINAS GERAIS - 'data''
'set xlab LONGITUDE'
'set ylab LATITUDE'

'printim ../output/ultima_img_MG.png x1400 y1000'

'quit'
EOF

grads -lbc "${file}_MG.gs"
rm ${file}_MG.gs
